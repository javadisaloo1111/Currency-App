...
- ⬆️ بروزرسانی درون‌برنامه‌ای: پیدا کردن نسخهٔ جدید از ریلیز رسمی همین مخزن با Failover چندمنبعی (GitHub API + آینه‌های ثابت)، پیام خطای دقیق فارسی به‌جای «شما متصل نیستید»، دانلود با نمایش پیشرفت، راستی‌آزمایی اندازه/امضا/بسته و نصب با تأیید کاربر (تنظیمات ← بررسی بروزرسانی)
...
│   ├── update/      # کانال بروزرسانی: منابع+Failover، دانلود، راستی‌آزمایی، نصب
